...
class DependencyInjectorTest extends TestCase {
    ...
    public function testSetAndGetArgumentParser() {
        ...
        $this->di->setArgumentParser('null', new \ride\library\dependency\argument\NullArgumentParser());
    ...
    public function testGetUsesTheLastDefinedDependency() {
        ...
        $dependency1 = new Dependency('ride\\library\\dependency\\Dummy');
        $dependency1->addInterface($interface);
        $dependency2 = new Dependency('ride\\library\\dependency\\TestObject');
    ...
    public function testGetWithId() {
        ...
        $dependency1 = new Dependency('ride\\library\\dependency\\TestObject');
        $dependency1->addInterface($interface);
        $dependency1->setId($id);
        $dependency2 = new Dependency('ride\\library\\dependency\\Dummy');
        $dependency2->addInterface($interface);
    ...
    public function testGetInjectsDependencies() {
        $interface = 'ride\\library\\dependency\\TestInterface';
        $class = 'ride\\library\\dependency\\TestObject';
    ...
    public function testGetWithRecursiveInterface() {
        ...
        $dependency3 = new Dependency('ride\\library\\dependency\\TestObject');
    ...
    public function testGetThrowsExceptionWhenClassInInvalid() {
        ...
        $interface = 'ride\\library\\dependency\\TestInterface3';
    ...
    public function testSetInstance() {
        $interface = 'ride\\library\\dependency\\TestInterface';
        $interface2 = 'ride\\library\\dependency\\TestInterface2';
        ...
        $expected = array(
            'ride\\library\\dependency\\TestObject' => array(
                $instance6,
                $id => $instance3,
                $id2 => $instance4,
            ),
    ...
    public function testUnsetInstance() {
        ...
        $this->di->unsetInstance('ride\\library\\dependency\\TestObject', $id);
    ...
    public function testGetAttemptsToCreateUndefinedClasses() {
        $result = $this->di->get('ride\\library\\dependency\\TestObject2');
    ...
    public function testGetAttemptsToCreateUndefinedInterfaceThrowsException() {
        $this->di->get('ride\\library\\dependency\\TestInterface');
    }
    ...
    /**
     * @expectedException ride\library\dependency\exception\DependencyNotFoundException
     */
    ...
    public function testGetAll() {
        ...
        $dependency1 = new Dependency('ride\\library\\dependency\\TestObject', $id);
        $dependency1->addCall($construct1);
        $dependency1->addInterface($interface);
        $dependency2 = new Dependency('ride\\library\\dependency\\TestObject');
        $dependency2->addInterface($interface);
